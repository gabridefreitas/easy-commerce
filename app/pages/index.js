  ...
  return (
    <Container className="py-8 space-y-6">
      ...
      <Stack alignItems="center">
        <Pagination page={currentPage + 1} count={Math.max(totalPages, 1)} onChange={handlePageChange} color="primary" />
      </Stack>
...
export async function getServerSideProps(context) {
  ...
  const response = await api.get('/api/products', { params: { page, size: 4 } });
